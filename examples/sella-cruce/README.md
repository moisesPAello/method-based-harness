...
Claude Pro subscription (2026-06-04). See [`../../docs/findings.md`](../../docs/findings.md).
...
repo (hand-authored, uncommitted at time of writing). That branch is the known-good
**output**; this `profile.yaml` + `methodologies/sdd/` + `roles/` are the **input**.
Together they are the input→output pair the `init` generator will be built to reproduce.
